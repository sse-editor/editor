...
import type { BlockToolData, ToolConfig, ToolboxConfigEntry } from '@sse-editor/types/tools';
import type { SavedData } from '@sse-editor/types/data-formats';
import type { BlockAPI as BlockAPIInterface } from '@sse-editor/types/api';
