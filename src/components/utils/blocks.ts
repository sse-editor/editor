import type { BlockAPI } from '@sse-editor/types';
import type { ConversionConfig } from '@sse-editor/types/configs/conversion-config';
import type { SavedData } from '@sse-editor/types/data-formats';
import type { BlockToolData } from '@sse-editor/types/tools/block-tool-data';
