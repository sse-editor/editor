...
import type { InlineTool, SanitizerConfig, API } from '@sse-editor/types';
import type { Notifier, Toolbar, I18n, InlineToolbar } from '@sse-editor/types/api';
import { IconLink, IconUnlink } from '@sse-editor/icons';
