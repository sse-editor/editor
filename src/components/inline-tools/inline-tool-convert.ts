import { IconReplace } from '@sse-editor/icons';
import type { InlineTool, API } from '@sse-editor/types';
import type { MenuConfig, MenuConfigItem } from '@sse-editor/types/tools';
import * as _ from '../utils';
import type { Blocks, Selection, Tools, Caret, I18n } from '@sse-editor/types/api';
