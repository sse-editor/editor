import type { BlockAPI as BlockAPIInterface, Blocks } from '@sse-editor/types/api';
import type { BlockToolData, OutputBlockData, OutputData, ToolConfig } from '@sse-editor/types';
