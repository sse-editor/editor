...
import type { EditorConfig } from '@sse-editor/types';
 ...
 *
 * @license MIT
 * @see SSE Editor <https://sse-editor.github.io>
 * @author SSE World <https://sseworld.github.io>
 */
export default class SSEEditor {
  /**
