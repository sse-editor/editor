...
import {
  ...
  BlockAddedEvent,
} from "./events/block/BlockAdded";
import {
  BlockChangedMutationType,
  BlockChangedEvent,
} from "./events/block/BlockChanged";
import {
  BlockMovedMutationType,
  BlockMovedEvent,
} from "./events/block/BlockMoved";
import {
  BlockRemovedMutationType,
  BlockRemovedEvent,
} from "./events/block/BlockRemoved";
...
export as namespace SSEEditorJS;
export default SSEEditorJS;
